...
//            img.setImageData(((ProductImageMain) p.getProduct().getProductImages()).getImageData());
//            img.setName(((ProductImageMain) p.getProduct().getProductImages()).getName());
//            img.setImgId(((ProductImageMain) p.getProduct().getProductImages()).getImgId());
//            img.setType(((ProductImageMain) p.getProduct().getProductImages()).getType());
//            p.getProduct().setProductImages((Set<ProductImageMain>) img);
//        });
